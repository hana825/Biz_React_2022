...
router.delete("/remove/:id", (req, res) => {
  ...
  /*
  mongoose 모델의 findOneAndDelete 함수를 호출하여 d_id 값이 id 와 일치하는 데이터를 삭제하라
  findOneAndRemove : findOneAndModify로 변경되었다. 실제로 삭제하려면 findOneAndDelete
  */
...
: router, Controller에서 사용하는 RequestMethod
  get : 데이터를 요청할 때 _ a href
  post : 데이터를 추가할 때 _ form
  delete : 데이터를 삭제할 때 _ Ajax(fetch)
  put : 데이터를 업데이트 할 때 _ Ajax(fetch)
*/
